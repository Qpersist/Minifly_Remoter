...
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOA, GPIO_Pin_11)
#define NRF_CSN_LOW()       GPIO_ResetBits(GPIOA, GPIO_Pin_11)		        //csn置低
#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOA,GPIO_Pin_8)
#define NRF_CE_LOW()	      GPIO_ResetBits(GPIOA,GPIO_Pin_8)			      //CE置低
